...
//              utils.log().info("Seat num - "+seatNumberTable);
    ...
    public void splitEvenlyAction() {
        ...
        List<WebElement> coll = (List<WebElement>) driver.findElements(By.xpath("//XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeCollectionView/XCUIElementTypeCell"));
        int cell = coll.size();
        utils.log().info("split seat - " + cell);
        for (int i = 1; i <= cell; i++) {
            List<WebElement> seat1Table = (List<WebElement>) driver.findElements(By.xpath("//XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeCollectionView/XCUIElementTypeCell[" + i + "]/XCUIElementTypeOther[1]/XCUIElementTypeTable/XCUIElementTypeCell"));
...
//    }
    ...
    public void doSeperate(String no) {
        ...
        List<WebElement> tale = (List<WebElement>) driver.findElements(By.xpath("//XCUIElementTypeApplication[@name=\"Linga POS\"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeCollectionView/XCUIElementTypeCell/XCUIElementTypeOther[1]/XCUIElementTypeTable/XCUIElementTypeCell"));
        int count = tale.size();
...
//        utils.log().info("Tptal Value is SAME - "+totalAmount);
        WebElement cashValues = driver.findElement(By.xpath("//div[@id='os_cashOptionStr']//input"));
...
//                utils.log().info("Table Number - "+tableNO1Txt);
    ...
    public void selectMenuForGroupSeat() throws InterruptedException {
        ...
        List<WebElement> tale = (List<WebElement>) driver.findElements(By.xpath("//XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeCollectionView/XCUIElementTypeCell/XCUIElementTypeOther[1]/XCUIElementTypeTable/XCUIElementTypeCell"));
        int count = tale.size();
    ...
    public void dogroupSeat() {
        ...
        for (int a = 1; a <= cell; a++) {
            List<WebElement> seat1Table = (List<WebElement>) driver.findElements(By.xpath("//XCUIElementTypeOther[3]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[3]/XCUIElementTypeCollectionView/XCUIElementTypeCell[" + a + "]/XCUIElementTypeOther[1]/XCUIElementTypeTable/XCUIElementTypeCell"));
            int cells = seat1Table.size();
    ...
    public void verifyBatchCheckAvailable() throws InterruptedException {
        ...
        List<WebElement> check = (List<WebElement>) driver.findElements(By.xpath("//XCUIElementTypeApplication[@name=\"Linga POS\"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeTable/XCUIElementTypeCell"));
...
//        String batchText = batchInProgress.getText();
    ...
    public String selectMenuForDineOrderType(String cate1) throws Exception {
        driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
        WebElement New = driver.findElement(By.xpath("//div[contains(.,'New Check')]"));
        elementClick(New, "Tapped New");
        Select_RandomTable(driver);
...
//            test.log(LogStatus.FAIL, "Seat Quantity entering Screen is not displayed");
        ...
        elementClick(arrowDownForOtherMenuItems, "Arrow Down");
        WebElement cate12 = driver.findElement(By.xpath("//div[contains(@class,'center-name category-container')]//div[contains(.,'" + cate1 + "')]"));
        elementClick(cate12, "Tapped category");
        Thread.sleep(5000);
        /*****  RandOm Select Menu ****/
        Select_RandomMenuItems(driver);
...
//            test.log(LogStatus.FAIL, "Seat Quantity entering Screen is not displayed");
    ...
    public String selectMenuForDineInForSplitSeat(String cate) throws Exception {
        driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
        driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
        WebElement New = driver.findElement(By.xpath("//div[contains(.,'New Check')]"));
        elementClick(New, "Tapped New");
...
//            test.log(LogStatus.FAIL, "Seat Quantity entering Screen is not displayed");
    ...
    public String selectMenuForBarTabForSplitCheck(String cate) throws Exception {
        driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
...
//                    utils.log().info("Discount as 2 - " + discountName11[h] + " Qty - " + discountCount11[h] + " Amount - " + discountPrize11[h]);
    ...
    public String selectTheMenuFromOrderScreen(String cate) throws Exception {
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        driver.manage().timeouts().implicitlyWait(7, TimeUnit.SECONDS);
        WebElement New = driver.findElement(By.xpath("//div[contains(.,'New Check')]"));
        elementClick(New, "Tapped New");
...
//        utils.log().info("Extra one Checks is ADDED");
    ...
    public void ClickTheMenuOnTheNewSplitSeatScreen() {
        driver.manage().timeouts().implicitlyWait(4, TimeUnit.SECONDS);
        WebElement menuItem = driver.findElement(By.xpath("((//ion-grid[contains(@class,'orderDetails')]//ion-list)[2]//ion-item[contains(@class,'inserted item md item')]//ion-col[contains(@class,'menu-name')])[1]"));
        elementClick(menuItem, "Selected Menu Item As - " + menuItem.getText());
        TestUtils.menuNameSplitCheck = menuItem.getText();
    }
    ...
    public void clickNewSeatOnTheSplitSeatScreen() {
        driver.manage().timeouts().implicitlyWait(4, TimeUnit.SECONDS);
        List<WebElement> count = driver.findElements(By.xpath("//ion-app[contains(@id,'seat')]//ion-header//ion-col[1]"));
        int count1 = count.size();
        WebElement checkSeat = driver.findElement(By.xpath("//ion-app[@id='seat"+count1+"']//ion-header//ion-col[1]"));
        elementClick(checkSeat, "Selected Added Check");
    }
...
//        utils.log().info("Primary Check is SAME After Split Check - " + checkNumber.getText());
    ...
    public void selectMenuCloudPOSSs(String category) throws InterruptedException {
        ...
        for (int o = 1; o <= 180; o++) {
            ...
            if (find(menuCollection1, 2)) {
                List<WebElement> menuCollection = (List<WebElement>) driver.findElements(By.xpath("//XCUIElementTypeOther[2]/XCUIElementTypeCollectionView[1]/XCUIElementTypeCell"));
...
//            selectMenuForDineOrderType(Cate);
    ...
    public void createdSaleForCashierOut5(String Cate) throws Exception {
        driver.manage().timeouts().implicitlyWait(TestUtils.driverWAIT, TimeUnit.SECONDS);
        elementClick(cancelBtn, "Cancel selected");
